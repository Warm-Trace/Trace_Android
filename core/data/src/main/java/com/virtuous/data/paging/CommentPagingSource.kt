...
class CommentPagingSource(
...
) : PagingSource<Cursor<Int>, Comment>() {

    override suspend fun load(params: LoadParams<Cursor<Int>>): LoadResult<Cursor<Int>, Comment> {
        return try {
    ...
    override fun getRefreshKey(state: PagingState<Cursor<Int>, Comment>): Cursor<Int>? = null
